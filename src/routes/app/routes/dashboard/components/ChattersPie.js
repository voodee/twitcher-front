...
class ChattersPie extends Component {

	getOptions = createSelector(
		metrics => metrics.get('chatters'),
		chatters => {

			const
				bots = Math.round( chatters * .34 ),
				users = Math.round( chatters * .66 )
	...
	render() {
		return (
			<div className="box box-default">
				<div className="box-header">Качество чата</div>
