	...
	render() {
		...
		return (
			<ul className="nav" ref={(c) => {
				...
				<li className="nav-header"><span>Навигация</span></li>
				<li>
					<FlatButton href="#/app/dashboard"><i className="nav-icon material-icons">dashboard</i><span className="nav-text">Дашбоард</span></FlatButton></li>
				<li>
					<FlatButton href="#"><i className="nav-icon material-icons">pie_chart_outlined</i><span className="nav-text">Аналитика</span></FlatButton>
					<ul>
						<li><FlatButton className="prepend-icon" href="#/"><span>Рекомендации</span></FlatButton></li>
						<li><FlatButton className="prepend-icon" href="#/"><span>Логи</span></FlatButton></li>
					</ul>
				</li>
				<li>
					<FlatButton href="#"><i className="nav-icon material-icons">timeline</i><span className="nav-text">Рейтинги</span></FlatButton>
					<ul>
						<li><FlatButton className="prepend-icon" href="#/app/ratings/channels"><span>Каналы</span></FlatButton></li>
						<li><FlatButton className="prepend-icon" href="#/"><span>Пользователи</span></FlatButton></li>
						<li><FlatButton className="prepend-icon" href="#/"><span>Игры</span></FlatButton></li>
					</ul>
				</li>
				<li>
					<FlatButton href="#"><i className="nav-icon material-icons">settings</i><span className="nav-text">Настройки</span></FlatButton>
					<ul>
						<li><FlatButton className="prepend-icon" href="#/"><span>Профиль</span></FlatButton></li>
						<li><FlatButton className="prepend-icon" href="#/app/setting/pricing"><span>Тариф</span></FlatButton></li>
					</ul>
				</li>
				{/*<li>*/}
				{/*<FlatButton href="#/app/settings"><i className="nav-icon material-icons">pie_chart_outlined</i><span className="nav-text">Статистика</span></FlatButton>*/}
				{/*<ul>*/}
				{/*<li><FlatButton className="prepend-icon" href="#/"><span>Логи</span></FlatButton></li>*/}
				{/*</ul>*/}
				{/*</li>*/}
				{/*<li>*/}
				{/*<FlatButton href="#/app/settings"><i className="nav-icon material-icons">settings</i><span className="nav-text">Настройки</span></FlatButton>*/}
				{/*<ul>*/}
				{/*<li><FlatButton className="prepend-icon" href="#/app/setting/proxies"><span>Прокси</span></FlatButton></li>*/}
				{/*</ul>*/}
				{/*</li>*/}
